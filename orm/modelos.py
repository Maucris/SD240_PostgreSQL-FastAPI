...
#los modelos o clases modelos son las clases que mapean a las tablas 
from orm.config import BaseClass
#importar de SQLAlchemy los tipo de datos que usan las tablas 
from sqlalchemy import Column, String, Integer, DateTime, ForeignKey, Float
#calcular la hora actual 
import datetime

#por convencion las clases tienen nombres en singular y comiensan con mayusculas 
